...
1. Add the appropriate `yaml` files and copy `functions.sh` to your repo
...
4. Set the `CORELLIUM_API_TOKEN` secret ([our API Token documentation](https://support.corellium.com/administration/api-token))
