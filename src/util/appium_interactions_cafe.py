...
def interact_with_app(driver: webdriver.Remote, driver_wait: WebDriverWait):
    ...
    #wait_until_element_value(by=AppiumBy.ID, value="com.corellium.cafe:id/emailEditText", expected_value="Hello@corellium.com", wait=driver_wait)
